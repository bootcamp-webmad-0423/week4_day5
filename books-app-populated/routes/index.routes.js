...
const Author = require('../models/Author.model')        // Lo necesito para popular la ruta de detalles
...
router.get('/libros/detalles/:book_id', (req, res) => {
  ...
  Book
    .findById(book_id)
    .populate('author')     // Nombre del campo a popular (el que tiene los ObjectIds)
